...
import '../styles/CorporateBanner.css'; // Adjust path as needed
import iframeImage from '../assets/iframeImage.webp'; // Adjust path as needed
      ...
      <div className="corporate-banner-content">
        <div className="corporate-banner-container">
          ...
          <div className="corporate-description-wrapper">
            <div
              className={`corporate-description-text ${
                expanded ? 'expanded' : ''
              }`}
              id="contentBox"
            >
              ...
              <p>
                With WanderOn, it's not just business as usual; it's business
                mixed with an extraordinary dash of excitement! Let's turn those
                office outings into legendary tales of thrill and connections.
              </p>
        ...
        <div className="corporate-video-section">
          <img
            src={iframeImage}
            alt="Corporate Group"
            className="corporate-video-frame"
          />
        </div>
      </div>
